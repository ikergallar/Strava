...
public class VentanaCrearSesion extends JFrame {
    ...
    public VentanaCrearSesion(LoginController loginController,RetoController retoController, SesionController sesionController ) {
        ...
        btnCrearSesion.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				sesionController.crearSesion(loginController.getToken(), nombre, Deporte, distancia, fecha_ini, duracion);
