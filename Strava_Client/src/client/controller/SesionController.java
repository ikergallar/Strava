...
public class SesionController {
	...
	public ArrayList<SesionDTO> buscarSesiones(String titulo,String deporte, int distancia,Date fecha_ini, int duracion){
	        try {
	            return this.serviceLocator.getService().buscarSesiones(titulo,deporte, distancia,fecha_ini,duracion);
